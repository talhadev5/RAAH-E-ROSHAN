...
import 'package:raah_e_roshan/src/modules/admin_create_post/state.dart';

import 'package:raah_e_roshan/src/modules/notification_page/view.dart';

class AdminCreatePostLogic extends GetxController {
  final state = AdminCreatePostState().obs;
